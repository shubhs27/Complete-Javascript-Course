...
console.log(23 === 23.0); // js stores all numbers in float type

console.log(0.1 + 0.2); // js stores in binary format which causes maths errors like  this
...
console.log(Math.trunc(-23.3));
console.log(Math.floor(-23.3)); // floor is better
...
/*
// Numeric Separators
// we can only place underscores between 2 digits and not next to a decimal
...
// console.log(Math.sqrt(16n)); // Math functions don't work
...
console.log(new Date('December 24, 2015')); // don't use as it's unreliable

console.log(new Date(2037, 10, 19, 15, 23, 5)); // month is 0 based (10-november)
console.log(new Date(2037, 10, 32)); // autocorrects to next month days
